...
public class ManageUser implements ManageUserRemote {
	...
	public void fillDatabase()
	{
		...
		User u1 = new User("Peter", "Malı", "Petulo1","123456", a1, "petko@mail.com", "090912346");		
		...
		User u4 =new User("Peter", "Slepièka", "Peso","123456", a3, "peso@mail.com", "0000545674");
		...
		User u9 =new User("Ezekiel", "Dobrı", "treska","123456", a8, "ezod@mail.com", "7878965321");
		User u10 =new User("Arnold", "Hluchı", "dlonra","123456", a10, "arnoh@mail.com", "444465231");
		User u11 =new User("Jozef", "Hluchı", "jojo8","123456", a10, "jozko.hluchy@mail.com", "456123895");
		User u12 =new User("Ondrej", "Slepı", "onko","123456", a9, "ondryk@mail.com", "0909632157");
		...
		Group g1 = new Group("Mlados", members1, "Skupina pre internát Mlados v Mlynskej doline", sharing1);
		...
		Group g2 = new Group("Za kotolòou", members2, "Èervená a zelená bytovky za kotolòou", sharing2);
		...
		SharingType st6 = new SharingType("Poièanie");
		...
		Sharing s1 = new Sharing(st9, u4, ts1, "Jablká", "Darujem 2 kg jabåk", "zadarmo", g1, true, false, true);
		
		manager.persist(s1);
		
		Sharing s2 = new Sharing(st3, u4, ts1, "Jablká", "Predám 20 kg jabåk", "0.50€/kg", g2, true, true, true);
		manager.persist(s2);
		
		Sharing s3 = new Sharing(st8, u12, ts2, "Náhrdelník", "Našiel som na chodníku pred bytovkou zlatı náhrdelník", "", g2, false, false, false);
		manager.persist(s3);
		
		Reaction r1 = new Reaction(u5, s2, "Dobrı deò, mal by som záujem o 10 kg. Môme kedyko¾vek po 17:00", true, false, false);
		...
		Reaction r4 = new Reaction(u4, s3, "Moja priate¾ky podobnı h¾adá, môte ma kontaktova?", true, false, true);
