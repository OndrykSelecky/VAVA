...
public class ManageUser implements ManageUserRemote {
	...
	public void fillDatabase() {
		...
		Sharing s3 = new Sharing(st8, u12, ts2, "Náhrdelník", "Našiel som na chodníku pred bytovkou zlatý náhrdelník",
				"", g2, false, false, false);
		manager.persist(s3);

		Reaction r1 = new Reaction(u5, s2, "Dobrý deň, mal by som záujem o 10 kg. Môžme kedykoľvek po 17:00", true,
				false, false);
